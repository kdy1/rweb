...
use rweb_service::{Service, Transform};
use std::{
    rc::Rc,
    task::{Context, Poll},
};
...
///
/// ```rust
/// use rweb::middleware::errhandlers::{ErrorHandlers, ErrorHandlerResponse};
/// use rweb::{web, http, dev, App, HttpRequest, HttpResponse, Result};
///
...
mod tests {
    ...
    async fn test_handler() {
        ...
        let resp = test::call_service(&mut mw, TestRequest::default().to_srv_request()).await;
