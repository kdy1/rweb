...
///
/// **Note**: A query string consists of unordered `key=value` pairs, therefore
/// it cannot be decoded into any type which depends upon data ordering e.g.
/// tuples or tuple-structs. Attempts to do so will *fail at runtime*.
///
/// [**QueryConfig**](struct.QueryConfig.html) allows to configure extraction
/// process.
///
/// ## Example
///
...
///
/// ```rust
/// use rweb::{error, web, App, FromRequest, HttpResponse};
/// use serde_derive::Deserialize;
///
/// #[derive(Deserialize)]
/// struct Info {
